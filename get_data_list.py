...
def get_multi_style_data_list(mode, style_n, path_n=1, target_font1=None, target_font2=None,
        target_font3=None, target_fonts=None, target_chars=None):
    if mode == 'train':
        max_iter = train_iter
        savepath = train_save_path
    elif mode == 'test':
    ...
    for i in tqdm(range(max_iter)):
        ...
        if target_fonts != None:
            target_font1 = target_fonts[i // len(target_chars)]
            target_font2 = target_fonts[i // len(target_chars)]
            target_font3 = target_fonts[i // len(target_chars)]
