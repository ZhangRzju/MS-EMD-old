...
# init_interp_num = 100
# final_interp_num = 8
# data_dir = 'results/243/interp_HKLS_100/OLF/D1'
# save_dir = 'results/243/interp_HKLS_100/OLF/OL_avg_interp_%d' % final_interp_num
...
# f = open('results/243/interp_HKLS_100/OLF/pixels.csv', 'w')
...
# source_dir = 'fonts/siyuan_song_imgs/000'
# data_dir = 'datasets/243/images_resol_256'
...
# save_dir = '/data/wuyonglin/zi2zi/datasets/image_emd_train'
# if os.path.exists(save_dir):
#     utils.clear_dir(save_dir)
# else:
#     os.makedirs(save_dir)
...
# save_dir = '/data/wuyonglin/zi2zi/datasets/image_emd_val'
# if os.path.exists(save_dir):
#     utils.clear_dir(save_dir)
# else:
#     os.makedirs(save_dir)
